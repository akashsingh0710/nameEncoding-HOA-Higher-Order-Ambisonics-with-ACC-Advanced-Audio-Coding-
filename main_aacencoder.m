...
fp = fopen(strcat('.\Encoded_Bformat\encoded_',string,'.aac'),'w');
y = y*2^15;
y=[zeros(1,1024) y']';
...
for frame_index = 1:len - 1
    ...
    for sfb_offind=1:max_sfb_encoded
        ...
        % Using Average to calculate sfb and Quantized Coefficient, just
        % using something to calculate !! dont think, Its not correct
        % and not logical
